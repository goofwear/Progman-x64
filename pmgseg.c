	...
	DWORD   dwFlags)
{
	...
	PITEM      pItem;
	DWORD      cb;
	TCHAR      szCommand[3 * MAX_PATH + 1];
	TCHAR      szExeDir[MAX_PATH + 1]; // Replaced MAXITEMPATHLEN + 1 with MAX_PATH + 1
	TCHAR      szIconExe[MAX_PATH + 1];
	TCHAR      szTemp[MAX_PATH + 1]; // ditto
	LPTSTR     lp1, lp2, lp3;
	HANDLE     hIconRes;
	HANDLE     hModule;

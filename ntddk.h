...
#if defined(_WIN64)
#pragma comment(lib, "ntdll_64.lib")
#else
...
// NtQuerySystemInformation with SystemFileCacheInformation 

typedef struct _SYSTEM_FILECACHE_INFORMATION {
	ULONG_PTR CurrentSize;
	ULONG_PTR PeakSize;
	ULONG PageFaultCount;
	ULONG_PTR MinimumWorkingSet; // this and everything below it was introduced in NT4. So (K32)GetPerformanceInfo can't be implemented on NT 3.x out of the box.
...
typedef enum _MEMORY_INFORMATION_CLASS {
  ...
  MemorySectionName, // MemoryMappedFilenameInformation - 2003 source code
  Unk2,  // these two are not supported in Windows 2000 and earlier. Yet to check XP/2003.
